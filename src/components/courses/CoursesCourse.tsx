const CoursesCourse = ({ name, description, icon }: { name: string; description: string; icon: string }) => (
  <div className="course lg:basis-1/3-minus-20 relative rounded-[10px] bg-white px-[28px] md:mb-[56px] md:basis-1/2-minus-5 md:px-[32px] md:odd:ml-0 md:even:ml-[10px] lg:mb-[84px]">
    ...
    <button className="mb-[32px] mt-[24px] text-bodyM font-bold text-hotPink hover:text-lightPink">Get Started</button>
  </div>
);
