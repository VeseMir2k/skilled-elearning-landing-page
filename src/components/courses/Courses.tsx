...
const Courses = () => {
  ...
  return (
    <div className="bg-gradient_3 xl:flex xl:justify-center">
      <div className="courses flex flex-col gap-[44px] px-[16px] pb-[80px] md:flex-row md:flex-wrap md:gap-0 xl:w-[1280px]">
