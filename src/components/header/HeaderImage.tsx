...
const HeaderImage = () => (
  <picture>
    ...
    <img
      className="mb-[26px] mt-[66px] w-full scale-125 md:absolute md:right-[-300px] md:top-[-330px] md:z-[-1] md:w-[700px] md:scale-100 lg:right-[-250px] lg:top-[-280px] lg:scale-125"
      src={headerImgMobile}
